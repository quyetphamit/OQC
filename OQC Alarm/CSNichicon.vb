Public Class CSNichicon
    ...
    Private Sub CS_Toyodenso_FormClosed(sender As Object, e As System.Windows.Forms.FormClosedEventArgs)
        ...
        MainForm.Show()
    End Sub
    Private Sub CS_Toyodenso_Load(sender As System.Object, e As System.EventArgs)
        Timer1.Enabled = True
        Timer1.Interval = 500
        LoadMonth()
    End Sub
    ...
    Private Sub ButtonExport_Click(sender As System.Object, e As System.EventArgs) Handles ButtonExport.Click
        Using connect As New Database1Entities1
            ...
            If strcheck <> "" Then
                Dim Load = (From s In connect.Nichicons Where s.DateProduction.Contains(strcheck)).ToList

Public Class CS_Toyodenso
    ...
    Private Sub CS_Toyodenso_FormClosed(sender As Object, e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Timer1.Enabled = False
        Timer1.Interval = 500
        CS_Toyodenso_Load(sender, e)
        Me.Hide()
        MainForm.Show()
    End Sub
    Private Sub CS_Toyodenso_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Timer1.Enabled = True
        Timer1.Interval = 500
        LoadMonth()
    End Sub
    Public Sub LoadMonth()
        ...
        Using connect As New Database1Entities1
            ...
            Dim DateError = (From s In connect.TOYODENSOes Where s.DateProduction.Contains(TimeCheck)).ToList
    ...
    Private Sub ButtonExport_Click(sender As System.Object, e As System.EventArgs) Handles ButtonExport.Click
        Using connect As New Database1Entities1
            ...
            If strcheck <> "" Then
                Dim Load = (From s In connect.TOYODENSOes Where s.DateProduction.Contains(strcheck)).ToList
